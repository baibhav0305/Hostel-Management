...
export default function AdminSignIn() {
  ...
  let login = async (event) => {
    ...
    if (result.success) {
      ...
      localStorage.setItem("isAdmin", JSON.stringify(result.data.user.isAdmin));
      localStorage.setItem("isSuper", JSON.stringify(result.data.user.isSuper));
