...
function Leave() {
  ...
  const labels = ["Leaves", "Requested", "Present"];
  const loader = (
    <svg
      aria-hidden="true"
  ...
  return (
    <div className="w-full h-screen gap-10 flex flex-col items-center justify-center max-h-screen overflow-y-auto pt-[500px] sm:pt-96 md:pt-96 lg:pt-20">
      <h1 className="text-white font-bold text-5xl">Leaves</h1>
      {/* <ul className="flex gap-5 text-white text-xl px-5 sm:p-0 text-center">
        <li>Total Present: {daysofmonthtilltoday - leave} </li>
        <li>Leaves: {loading ? loader : leave}</li>
        ...
        <div className="h-[30vh] gap-2 flex items-center justify-center flex-wrap">
          <Doughnut
            ...
            data={{
              ...
              datasets: [
                {
                  label: "Leaves",
                  data: [leave, requests, daysofmonthtilltoday - leave],
          ...
          <ul className="text-white">
            <li className="flex gap-2">
              {" "}
              <span className="w-10 h-5 bg-orange-500 block"></span> Leaves
            </li>
            <li className="flex gap-2">
              {" "}
      ...
      >
        ...
        >
          {loading ? <div>{loader} Sending Request...</div> : "Request Leave"}
        </button>
        <ToastContainer
          position="top-right"
          autoClose={5000}
