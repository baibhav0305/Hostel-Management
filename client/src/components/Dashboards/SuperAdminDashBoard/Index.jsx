...
export default function Index() {
  ...
  const links = [
    ...
    },
    {
      ...
      url: "/super-admin-dashboard/register-student",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      text: "Register Admin",
      url: "/super-admin-dashboard/register-admin",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      text: "Hostel",
      url: "/super-admin-dashboard/hostel",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    // {
    //   text: "Attendance",
    //   url: "/super-admin-dashboard/attendance",
    //   svg: (
    //     <svg
    //       xmlns="http://www.w3.org/2000/svg"
    //       fill="none"
    ...
    {
      text: "All Students",
      url: "/super-admin-dashboard/all-students",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      text: "Hostel Change",
      url: "/super-admin-dashboard/hostel-change",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    // {
    //   text: "Mess",
    //   url: "/super-admin-dashboard/mess",
    //   svg: (
    //     <svg
    //       xmlns="http://www.w3.org/2000/svg"
    //       fill="none"
